...
const CmdPalette = (function() {
  ...
  const PAGES = [
    ...
    { title: 'Brain Proof', sub: 'Verifiable proof the brain is actually learning', url: 'brain-proof.html', icon: '🔬' },
    { title: 'Site Health', sub: 'Cumulative diagnostic dashboard', url: 'site-health.html', icon: '🏥' },
    { title: 'Audit Log', sub: '173+ audit passes, 24 CRITICAL bugs fixed', url: 'audit-log.html', icon: '🔍' },

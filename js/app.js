...
function buildNav(activePage) {
  ...
  const playsGrp = ['totd','plays','signals','earnings','earnings-preview','pre-market','zero-dte','setup-wizard','paper-trade','game-plan','hot-movers','squeeze-radar','trade-plan','trade-of-the-day'];
  ...
  const navHtml = ''
    ...
    + '<a href="pick-of-day.html">🎯 Pick of the Day <span class="feat-badge feat-live" style="font-size:8px;padding:0 5px;">TRACKED</span></a>'
    ...
    + '<div class="nav-dropdown">'
    + '<a href="edge-scorecard.html">📊 Edge Scorecard <span class="feat-badge feat-live" style="font-size:8px;padding:0 5px;">RECEIPT</span></a>'
    ...
    + '<a href="reliability-diagram.html">📐 Reliability Diagram <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#a78bfa;color:#000;">ECE</span></a>'
    + '<a href="brain-coach-live.html">🧑‍🏫 Brain Coach (Live) <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#10b981;color:#000;">PLAIN</span></a>'
    + '<a href="volume-tracker.html">📊 Volume + Latency <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#a78bfa;color:#000;">HEALTH</span></a>'
    + '<a href="prediction-histogram.html">📊 Prediction Histogram <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#10b981;color:#000;">DIST</span></a>'
    + '<a href="per-symbol-meta-stacker.html">🧱 Per-Symbol Stacker <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#a78bfa;color:#000;">SYM-BLEND</span></a>'
    + '<a href="self-distillation.html">🧙 Self-Distillation <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#10b981;color:#000;">SWA-TEACHER</span></a>'
    + '<a href="counterfactual-replay.html">🔄 Counterfactual Replay <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#a78bfa;color:#000;">ROBUST</span></a>'
    + '<a href="daily-cards.html">📆 Daily Cards <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#10b981;color:#000;">EOD</span></a>'
    + '<a href="brain-backup.html">💾 Brain Backup <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#00d4ff;color:#000;">EXPORT</span></a>'
    + '<a href="mixup.html">🧬 Mixup Augmentation <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#a78bfa;color:#000;">SYNTH</span></a>'
    + '<a href="historical-bootstrap.html">⏪ Historical Bootstrap <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#10b981;color:#000;">WARM-START</span></a>'
    + '<a href="train-now.html">⚡ Train Now <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#f59e0b;color:#000;">1-CLICK</span></a>'
    + '<a href="learning-velocity.html">📈 Learning Velocity <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#00d4ff;color:#000;">METRICS</span></a>'
    + '<a href="brain-debug.html">🩺 Brain Debug <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#ef4444;color:#fff;">OPS</span></a>'
    + '<a href="site-health.html">🏥 Site Health <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;background:#10b981;color:#000;">HEALTH</span></a>'
    + '<a href="owner-checklist.html">🛠 Owner Checklist <span class="feat-badge feat-new" style="font-size:8px;padding:0 5px;">SETUP</span></a>'

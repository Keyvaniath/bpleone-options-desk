...
function buildNav(activePage) {
  ...
  const playsGrp = ['totd','options-lab','options-tranches','spy-radar','options-board','play-journal','plays','horizons','broadcast','signals','earnings','earnings-preview','pre-market','zero-dte','setup-wizard','paper-trade','game-plan','hot-movers','squeeze-radar','trade-plan','trade-of-the-day'];
  ...
  const navHtml = ''
    ...
    +   '<a href="options-board.html">🗒 Options Board</a>'
    +   '<a href="play-journal.html">📝 Play Journal</a>'

...
function buildNav(activePage) {
  ...
  const playsGrp = ['totd','options-lab','options-tranches','spy-radar','options-board','plays','horizons','broadcast','signals','earnings','earnings-preview','pre-market','zero-dte','setup-wizard','paper-trade','game-plan','hot-movers','squeeze-radar','trade-plan','trade-of-the-day'];
